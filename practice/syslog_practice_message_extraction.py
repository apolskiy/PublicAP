...
"""This script extracts messages by application from syslog.log
without using any OS command line tools"""
...
with open('user_statistics_practice.csv', 'w', newline='',encoding='utf-8') as user_csv:
...
with open('error_message_practice.csv', 'w', newline='',encoding='utf-8') as error_csv:
